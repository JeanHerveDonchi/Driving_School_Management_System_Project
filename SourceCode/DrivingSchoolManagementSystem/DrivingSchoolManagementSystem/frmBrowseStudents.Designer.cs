...
{
    partial class frmBrowseStudents
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            groupBox1.Text = "Choose a student";
            // 
            // cmbStudents
            // 
            cmbStudents.FormattingEnabled = true;
            cmbStudents.Location = new Point(76, 36);
            cmbStudents.Name = "cmbStudents";
            cmbStudents.Size = new Size(338, 23);
            cmbStudents.TabIndex = 1;
            cmbStudents.SelectedValueChanged += cmbStudent_SelectedValueChanged;
            // 
            // label2
            // 
            ...
            dgvStudents.Location = new Point(30, 241);
            dgvStudents.Name = "dgvStudents";
            dgvStudents.Size = new Size(644, 205);
            ...
            Controls.Add(label1);
            Name = "frmBrowseStudents";
            Text = "Browse Instructors";
            Load += frmBrowseStudent_Load;
            Leave += frmBrowseStudents_Leave;
